        ...
        unitTests {
            ...
            all {
                ...
                for (key in listOf(
                    ...
                    "pitch.zip", "kanji.zip", "kindle.settings", "kindle.sync", "anki.reorderAddon", "kindle.refreshAudio", "kindle.refreshCards", "kindle.refreshExclude", "audio.archive", "voicevox.root", "voicevox.onnxruntime"
                )) {
